...
/// StockFlow Enterprise Dark Theme
class AppDarkTheme {
  AppDarkTheme._();
  ...
  static ThemeData get theme {
    final colorScheme = ColorScheme.dark(
      ...
      outline: DesignTokens.grey600,
      outlineVariant: DesignTokens.grey700,
      surfaceContainerHighest: DesignTokens.darkSurfaceHigh,
  ...
  static ElevatedButtonThemeData _elevatedButtonTheme(ColorScheme colorScheme) {
    return ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        textStyle: AppTypography.darkTextTheme.labelLarge?.copyWith(fontWeight: FontWeight.w600),
  ...
  static InputDecorationTheme _inputDecorationTheme(ColorScheme colorScheme) {
    return InputDecorationTheme(
      ...
      errorStyle: AppTypography.darkTextTheme.bodySmall?.copyWith(color: colorScheme.error),
    );
  }
  ...
  static NavigationBarThemeData _navBarTheme(ColorScheme colorScheme) {
    return NavigationBarThemeData(
      ...
      labelTextStyle: WidgetStateProperty.resolveWith((states) {
        ...
        return AppTypography.darkTextTheme.labelSmall;
      }),
    );
  }
  ...
  static ListTileThemeData _listTileTheme(ColorScheme colorScheme) {
    return ListTileThemeData(
      ...
      leadingAndTrailingTextStyle: AppTypography.darkTextTheme.bodyMedium,
  ...
  static BadgeThemeData _badgeTheme(ColorScheme colorScheme) {
    return BadgeThemeData(
      ...
      textStyle: AppTypography.darkTextTheme.labelSmall,
    );
  }
}
