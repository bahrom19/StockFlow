...
class ReportExport {
  ...
  static Future<Uint8List> buildPdf({
    ...
    // primary PDF fonts so RU/KK copy actually renders.
      ...
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          pw.Text(l10n?.reportPdfPerformanceSummary ?? 'Performance Summary',
              style: pw.TextStyle(font: PdfFonts.bold, fontSize: 13)),
          ...
          pw.Table(
            ...
            children: [
              pw.TableRow(
                ...
                children: [
                  _cell(l10n?.number ?? 'Number', bold: true),
                  _cell(l10n?.date ?? 'Date', bold: true),
                  _cell(l10n?.status ?? 'Status', bold: true),
                  _cell(l10n?.total ?? 'Total', bold: true),
                  _cell(l10n?.paid ?? 'Paid', bold: true),
                ],
              ),
              if (sales.isEmpty)
                pw.TableRow(
